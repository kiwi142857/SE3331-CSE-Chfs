...
void chfs_read(fuse_req_t req, fuse_ino_t ino, size_t size, off_t off, struct fuse_file_info *fi)
{
    ...
    // we print off and size to debug
    std::cerr << "Read file from inode " << ino << " at off " << off << " with " << size << std::endl;
...
void chfs_readlink(fuse_req_t req, fuse_ino_t ino)
{
    UNIMPLEMENTED();
}
...
void chfs_symlink(fuse_req_t req, const char *link, fuse_ino_t parent, const char *name)
{
    UNIMPLEMENTED();
}
...
void chfs_link(fuse_req_t req, fuse_ino_t ino, fuse_ino_t newparent, const char *newname)
{
    UNIMPLEMENTED();
}
 ...
 * version 2.5
 */
void chfs_statfs(fuse_req_t req, fuse_ino_t ino)
{
    UNIMPLEMENTED();
}
 ...
 * Changed in version 2.2
 */
void chfs_fsync(fuse_req_t req, fuse_ino_t ino, int datasync, struct fuse_file_info *fi)
{
    UNIMPLEMENTED();
}
 ...
 * Introduced in version 2.3
 */
void chfs_releasedir(fuse_req_t req, fuse_ino_t ino, struct fuse_file_info *fi)
{
    UNIMPLEMENTED();
}
 ...
 * Introduced in version 2.3
 */
void chfs_fsyncdir(fuse_req_t req, fuse_ino_t ino, int datasync, struct fuse_file_info *fi)
{
    UNIMPLEMENTED();
}
